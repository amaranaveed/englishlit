...
// ─── AN INSPECTOR CALLS — Theme Analysis Sheets ───

export const INSPECTOR_CALLS_THEME_SHEETS: ThemeSheet[] = [
  {
        ...
        quotes: [
          {
            ...
            who: "Stage direction / Mr Birling",
            act: "Act 3 (final line)",
            analysis: [
  ...
  },
  {
    ...
    points: [
      ...
      },
      {
        ...
        quotes: [
          {
            quote: "you ought to like this port, Gerald... it's exactly the same port your father gets",
            who: "Arthur Birling",
            act: "Act 1",
            analysis: [
          ...
          {
            quote: "you know of course that my husband was Lord Mayor only two years ago",
            who: "Sybil Birling",
            act: "Act 2",
            analysis: [
      ...
      },
      {
        ...
        quotes: [
          {
            quote: "his whole manner of handling the decanter and then the drink shows his familiarity with quick heavy drinking",
            who: "Stage Directions",
            act: "Act 3",
            analysis: [
          ...
          {
            quote: "you're not the type — you don't get drunk",
            who: "Sybil Birling",
            act: "Act 3",
            analysis: [
