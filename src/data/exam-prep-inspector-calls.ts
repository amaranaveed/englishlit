...
export const INSPECTOR_CALLS_ESSAYS: ExampleEssay[] = [
  {
    question:
      "Starting with this extract, how does Priestley present ideas about social responsibility in An Inspector Calls? Write about how Priestley presents social responsibility in this extract and in the play as a whole.",
...
However, the older generation's refusal to accept responsibility reveals why the Inspector's warning in the extract carries such urgency. Birling's response upon learning the Inspector may not be genuine, "The whole thing's different now," demonstrates that his concern was never ethical but reputational - he cares about scandal, not about Eva Smith. Priestley uses Birling's relief to expose the fundamental moral failure of the capitalist class: they will only behave responsibly when forced to by external consequences, never from genuine conscience. The cyclical structure of the ending, in which a second inspector is announced, returns the audience to the extract's central ultimatum: learn the lesson voluntarily, or be taught it in "fire and blood and anguish." The play refuses its audience a comfortable resolution because Priestley's argument is that the question of social responsibility is never settled - it must be confronted by every generation, and the cost of failure is measured in human lives.`,
    ...
    techniqueDissections: [
      ...
      },
      {
        ...
        termUsed: '"The cyclical structure of the ending, in which a second inspector is announced, returns the audience to the extract\'s central ultimatum"',
    ...
    examinerCommentary: [
      {
        ...
        aoCoverage: ["AO1", "AO3"],
        gradeJustification: "Top-band introductions argue, not describe. This one frames the extract as Priestley's 'mouthpiece to articulate the socialist case for collective responsibility'. The AO3 is integrated into the thesis  - not separated into its own paragraph  - which is a Grade 9 marker.",
      },
      {
        paragraph: 2,
        label: "Extract Analysis  - Imperative, Tripling, Organic Metaphor",
        whatExaminerSees: "Dense analysis of the extract's opening: the imperative 'just remember this' is explained, tripling of 'millions' connected to systemic scale, and the organic metaphor 'intertwined' contrasted with Birling's insistence on separation. Multiple AO2 points woven together with contextual understanding.",
        aoCoverage: ["AO1", "AO2", "AO3"],
      ...
      {
        paragraph: 5,
        label: "Mr Birling  - Capitalist Individualism (Wider Play)",
        whatExaminerSees: "Birling's philosophy identified as the ideological counterpoint the extract dismantles. Repetition of 'his own' analysed conceptually. Dramatic irony of the Titanic connected to a 'structural argument' about ruling-class delusion. The student demonstrates whole-text awareness by linking the wider play to the extract.",
        aoCoverage: ["AO1", "AO2", "AO3"],
        gradeJustification: "The student explains that Priestley 'has already undermined Birling's credibility' so that the extract's collectivist argument lands with full force. The insight that 'their certainty about economic matters deserves the same scepticism as their certainty about the Titanic' is a sharp structural argument that links two moments across the play. This is top-band AO2.",
      },
      {
        paragraph: 6,
      ...
      },
      {
        ...
        whatExaminerSees: "Birling's 'The whole thing's different now' analysed as evidence that his concern 'was never ethical but reputational'. Cyclical structure identified. The essay ends by returning to the extract's central ultimatum: 'fire and blood and anguish'. The final sentence argues that 'the question of social responsibility is never settled'.",
        aoCoverage: ["AO1", "AO2", "AO3"],
...
Birling's most damning characteristic is his refusal to change, which Priestley contrasts with Sheila to sharpen the play's argument about generational responsibility. Upon learning the Inspector may not be genuine, Birling responds with immediate relief: "The whole thing's different now." The adjective "different" does not indicate moral reassessment; it indicates that the threat of public scandal has been removed, and with it any motivation for self-examination. This is Priestley's diagnosis of the capitalist class: they will only behave responsibly when forced to by external consequences, never from genuine conscience. Eric's accusation, "You're not the kind of father a chap could go to when he's in trouble," exposes the personal cost of Birling's ideology - he has built a family on obedience and material provision rather than moral guidance, mirroring how the Edwardian ruling class governed: maintaining order through wealth and authority while failing to provide genuine social leadership. The cyclical ending, with a second inspector on the way, ensures that the moral test Birling failed will recur - just as his incomplete speech in the extract will echo through the play until someone finishes the sentence with the right answer.`,
    ...
    examinerCommentary: [
      ...
      {
        paragraph: 2,
        label: "Extract Analysis  - Patronising Appeal and Possessive Pronouns",
      ...
      {
        paragraph: 4,
        label: "Wider Play  - Titanic and Dramatic Irony",
      ...
      },
      {
        ...
        whatExaminerSees: "Birling's 'The whole thing's different now' analysed as evidence that concern was 'never ethical but reputational'. Eric's accusation used as evidence against Birling. The cyclical ending connected to the extract's incomplete speech. The student widens from character to class to history.",
        aoCoverage: ["AO1", "AO2", "AO3"],
        gradeJustification: "The conclusion tracks Birling's moral failure through multiple lenses: parental failure (Eric's accusation reveals 'a family built on obedience and material provision rather than moral guidance'), class failure (mirroring 'how the Edwardian ruling class governed'), and structural failure (the cyclical ending ensures 'the moral test Birling failed will recur'). The final image  - 'his incomplete speech in the extract will echo through the play until someone finishes the sentence with the right answer'  - has genuine rhetorical force.",
      },
    ],
  ...
  {
    question:
      "Starting with this extract, how does Priestley use the character of Sheila to present ideas about change? Write about how Priestley presents Sheila in this extract and in the play as a whole.",
...
In the wider play, Priestley carefully constructs the starting point from which this transformation is measured. The stage directions describe Sheila as "very pleased with life and rather excited" - phrases that establish her as a product of bourgeois privilege who has never needed to question the system that produced her comfort. Her engagement to Gerald is framed less as a love story than as a business transaction: Birling's "your engagement to Sheila means a tremendous lot to me" places the emphasis on "to me," revealing that Sheila's marriage serves her father's social ambitions rather than her own happiness. The opening lighting, described as "pink and intimate," functions as a visual metaphor for the entire Birling worldview: rose-tinted, warm, and fundamentally dishonest. Priestley establishes this sheltered world so precisely because the audience must understand exactly what Sheila is surrendering when she chooses moral truth over comfortable ignorance. By the time of this extract, she has left the "pink and intimate" world permanently - she has entered the "brighter and harder" light of moral reality, and Priestley's point is that this cannot be reversed. Once you have seen the human cost of your privilege, you cannot unsee it.
...
The extract represents the culmination of this journey. Sheila has effectively become the Inspector's successor, carrying his moral authority forward after his departure and directing it at her own family. For the 1945 audience, the general election was fundamentally a choice between Birling's worldview and the Inspector's, and Sheila functions as Priestley's proof that change is possible - but only through the painful process of confronting your own complicity, accepting genuine shame, and refusing to retreat into the "same old way." The cyclical ending, with a real inspector announced, suggests that this moral test will recur until society passes it. Priestley's final question is not whether Sheila will pass it again - the audience can be confident she will - but whether they themselves will follow her example, or whether they will join the older Birlings in pretending that nothing has changed.`,
    ...
    examinerCommentary: [
      ...
      {
        paragraph: 2,
        label: "Extract Analysis  - 'Pretending' and the Generational Divide",
