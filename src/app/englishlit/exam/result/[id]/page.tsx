  ...
  if (!response) {
    return (
      ...
      >
        ...
        <Link href="/englishlit/exam" className="font-ui text-sm text-teal hover:underline mt-4 inline-block">
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <motion.nav
        ...
        transition={{ duration: 0.4, ease: EASE }}
      >
        <Link href="/englishlit/exam" className="hover:text-teal transition-colors">
          Exam Practice
        </Link>
      ...
      >
        <motion.div whileHover={{ x: -3 }} transition={{ duration: 0.2 }}>
          <Link href="/englishlit/exam" className="font-ui text-sm text-teal hover:underline">
