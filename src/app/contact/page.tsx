...
import { AnimatedPage, AnimatedHeading, AnimatedDiv, AnimatedSection, AnimatedListItem, AnimatedIcon, AnimatedWiggle, AnimatedInteractiveCard, AnimatedRevealLine } from "@/components/AnimatedWrappers";
    ...
    <div className="max-w-3xl mx-auto px-6 sm:px-10 lg:px-16 py-12">
      <AnimatedPage>
        ...
        <div className="space-y-8">
          ...
          {/* Divider between email and common topics */}
          <AnimatedRevealLine />
            ...
            <div className="rounded-2xl border border-border-subtle bg-surface p-6 sm:p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <AnimatedInteractiveCard key={item.title} index={index}>
                    <div className="rounded-xl bg-bg p-4 border border-border-subtle/50">
